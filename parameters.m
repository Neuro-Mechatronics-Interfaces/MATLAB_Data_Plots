...
pars.emg_averages.Filtering = get_default_filtering_pars(pars.emg_averages.Acquisition_Type, pars.emg_averages.EMG_Type, "Rectified"); % Return default filtering struct
