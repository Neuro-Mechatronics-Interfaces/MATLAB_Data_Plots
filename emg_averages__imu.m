...
if (numel(varargin) == 1) && isstruct(varargin{1})
    ...
    pars.EMG_Type = "Accelerometer"; % Can be: "Array" | "Bipolar | Accelerometer"
    ...
    [pars.Output_Root, pars.Version, pars.Input_Root] = parameters('generated_data_folder', 'version', 'raw_data_folder'); % Location where output figures are saved.
    ...
    pars.Trigger_Channel = 'TRIGGERS'; % Name of Trigger Channel
